...
st.subheader("Graph 4: Price by TypeName")
#u can edit the graph name part
...
st.markdown('`Findings and Observations`')
st.markdown("This bar chart shows the average price of laptops based on their type, revealing trends in pricing for different categories.")
